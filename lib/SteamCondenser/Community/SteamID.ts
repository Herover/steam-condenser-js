...
export class SteamID {
  public static ConvertCommunityIDToSteamID(communityID: number): string {
    const steamID1 = communityID % 2;
  ...
  public static ConvertCommunityIdToSteamId3(communityID: number): string {
    const steamID1 = 1;
    const steamID2 = BigNum.sub(communityID, new BigNum('76561197960265728'));
